package sample.democafekiosk.spring.api.service.order;
...
import sample.democafekiosk.spring.domain.order.OrderRepository;
import sample.democafekiosk.spring.domain.orderproduct.OrderProductRepository;
...
import sample.democafekiosk.spring.domain.stock.Stock;
import sample.democafekiosk.spring.domain.stock.StockRepository;
...
import static sample.democafekiosk.spring.domain.product.ProductType.*;
